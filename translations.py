...
TRANSLATIONS = {
    "it": {
        ...
        "update_ollama_tooltip": "Aggiorna Ollama all'ultima versione",
        "update_docker_button": "🐳 Aggiorna Docker",
        "update_docker_tooltip": "Aggiorna Docker all'ultima versione",
        "update_deps_button": "🐍 Aggiorna Dipendenze",
        "update_deps_tooltip": "Aggiorna le dipendenze Python del progetto",
        "update_ollama_confirm": "Aggiornare Ollama all'ultima versione?",
        "updating_ollama": "Aggiornamento Ollama...",
        "update_docker_confirm": "Aggiornare Docker?\nServe la password di amministratore.",
        "updating_docker": "Aggiornamento Docker...",
        "updating_deps": "Aggiornamento dipendenze Python...",
        ...
        # STARTUP THREAD
        "startup_checking_venv": "Verifica ambiente Python...",
        "startup_creating_venv": "Creazione ambiente virtuale...",
    ...
    "en": {
        ...
        "update_ollama_tooltip": "Update Ollama to the latest version",
        "update_docker_button": "🐳 Update Docker",
        "update_docker_tooltip": "Update Docker to the latest version",
        "update_deps_button": "🐍 Update Dependencies",
        "update_deps_tooltip": "Update Python project dependencies",
        "update_ollama_confirm": "Update Ollama to the latest version?",
        "updating_ollama": "Updating Ollama...",
        "update_docker_confirm": "Update Docker?\nAdministrator password required.",
        "updating_docker": "Updating Docker...",
        "updating_deps": "Updating Python dependencies...",
        ...
        # STARTUP THREAD
        "startup_checking_venv": "Checking Python environment...",
        "startup_creating_venv": "Creating virtual environment...",
